const parks = {
  ...
  cany: {
    ...
    drawerSummary:
      "Converging rivers, red-rock mesas, buttes, spires, and remote districts cut deep into southeast Utah.",
    hero: {
      eyebrow: "Featured Park",
      tagline:
        "A southeast Utah park where the Green and Colorado rivers split a high desert into four vast districts.",
      landmarkLabel: "Mesa Arch and the canyon country beyond Island in the Sky",
      titlePrimarySize: "clamp(3.15rem, 10.2vw, 7.6rem)",
      titleSecondarySize: "clamp(0.95rem, 2.05vw, 1.55rem)",
      titleMaxWidth: "48rem",
      titleOffsetY: "-14vh",
      titlePrimaryWhiteSpace: "nowrap",
      titleSecondaryWhiteSpace: "nowrap",
      media: {
        background: "./assets/CNYN/canyonlands-hero-background.jpg",
        backgroundPosition: "center center",
        backgroundInset: "0",
        backgroundParallaxSpeed: "0.04",
        backgroundScale: "calc(1.08 - (var(--hero-progress, 0) * 0.04))",
        backgroundAsImage: true,
        backgroundFilter: "none",
        foreground: "./assets/CNYN/canyonlands-hero-foreground.png",
        foregroundWidth: "100%",
        foregroundHeight: "100%",
        foregroundBottom: "0",
        foregroundLeft: "0",
        ...
        foregroundTravel: "0vh",
        foregroundAlt:
          "Mesa Arch framing Canyonlands cliffs, spires, and distant mountains",
      },
      highlightTitle:
        "A Utah desert park where two rivers divide one of the Southwest's broadest red-rock landscapes",
      highlightBody:
        "Established on September 12, 1964, Canyonlands preserves 337,598 acres of canyons, mesas, buttes, fins, arches, and spires in southeast Utah. The Green and Colorado rivers divide the park into four districts, and that separation defines the experience: Island in the Sky, The Needles, The Maze, and the rivers themselves each reveal a different version of the same eroded plateau landscape.",
      stats: [
        { label: "Established", value: "1964" },
        { label: "Districts", value: "4" },
        { label: "Rivers", value: "Green + Colorado" },
      ],
    },
    overview: {
      title:
        "A park of separate districts and one shared geologic logic: uplifted desert rock cut apart by water, gravity, and time.",
      body: "Canyonlands sits in the heart of southeast Utah's high desert, centered on the confluence of the Green and Colorado rivers. From overlooks, it can feel almost abstract: stacked sandstone, flat-topped mesas, isolated buttes, and canyons that keep multiplying outward. Up close, each district changes the experience. Island in the Sky emphasizes wide views, the Needles turns the stone into dense spires and backcountry routes, and the Maze pushes the same landscape toward remoteness and self-reliance.",
      notes: [
        {
          title: "Four districts, no shortcuts",
          text: "No roads within the park cross the rivers to directly connect the districts, so areas that look close on a map can still take hours to reach by car.",
        },
        {
          title: "Water and gravity do the carving",
          text: "NPS describes water and gravity as the prime architects of Canyonlands, stripping sedimentary layers into cliffs, benches, buttes, towers, and deep river canyons.",
        },
        {
          title: "Utah's largest national park",
          text: "At 337,598 acres, Canyonlands is Utah's largest national park and one of the clearest expressions of Colorado Plateau scale.",
        },
      ],
    },
    chapters: [
      {
        title:
          "Canyonlands begins as a high rock table, then the rivers and storms start stripping it into depth.",
        body: "Most of the park's visible stone was laid down as sediment and later lifted with the Colorado Plateau. Once the land stood high enough, the Green and Colorado rivers and countless tributaries cut downward through the rock layers. The result is less one canyon than a whole network of cliffs, shelves, towers, and river gorges that expose the plateau by subtraction.",
        factLabel: "Geology",
        fact: "NPS describes Canyonlands as a showcase of erosion, where the Green River carved channels through rock layers deposited nearly 300 million years ago.",
        scenicLabel:
          "Mesa Arch framing deep canyon country and distant mountain silhouettes",
        image: {
          src: "./assets/CNYN/canyonlands-story-1.jpg",
          alt: "Mesa Arch framing distant Canyonlands spires and plateau country",
          position: "center center",
        },
      },
      {
        title:
          "The rivers divide the park into separate worlds, each with its own pace, routes, and scale.",
        body: "Canyonlands is unified geologically but split experientially. Island in the Sky offers paved overlooks above sheer drops; the Needles rewards hiking and four-wheel drive with a more intimate maze of spires, joints, and backcountry routes; the Maze is remote enough that time, navigation, and self-sufficiency become part of the experience. Even the rivers are not just boundaries but distinct corridors through the land.",
        factLabel: "Districts",
        fact: "NPS notes that no roads within the park cross the rivers to directly link its districts, so moving between them can require two to six hours by car.",
        scenicLabel:
          "Separated mesas, spires, and river corridors across the Canyonlands plateau",
        image: {
          src: "./assets/CNYN/canyonlands-story-2.jpg",
          alt: "A river corridor winding between red canyon walls in Canyonlands National Park",
          position: "center center",
        },
        art: {
          top: "#16233a",
          ...
          bottom: "#d9b07f",
          orb: "#ffe0aa",
          orbGlow: "rgba(255, 209, 143, 0.28)",
          haze: "rgba(207, 171, 128, 0.22)",
          layerA: "#af7f5b",
          layerB: "#6e4934",
          layerC: "#322117",
          river: "rgba(163, 203, 223, 0.18)",
          riverOpacity: "0.14",
          fallsOpacity: "0",
          starsOpacity: "0",
          orbLeft: "16%",
      ...
      {
        title:
          "What stays with people is the combination of openness and remoteness: a park built for horizon, silence, and long approach.",
        body: "Canyonlands does not rely on one iconic wall or single summit. Its scale comes from distance and compartmentalization. You look across huge space, but access is often slow and deliberate, which preserves a strong sense of solitude. That is part of why the park feels so different from nearby scenic drives elsewhere on the plateau: the land is visually immense and logistically demanding at the same time.",
        factLabel: "Scale",
        fact: "Canyonlands is Utah's largest national park at 337,598 acres, and NPS emphasizes that most visitors find it impractical to see more than one district in a single trip.",
        scenicLabel:
          "Remote red-rock mesas and canyons fading into evening desert haze",
        image: {
          src: "./assets/CNYN/canyonlands-story-3.jpg",
          alt: "Broad Canyonlands mesas and canyons stretching across the desert plateau",
          position: "center center",
        },
        art: {
          top: "#0c1524",
          ...
          bottom: "#9a6c4f",
          orb: "#f4dfb4",
          orbGlow: "rgba(241, 220, 178, 0.22)",
          haze: "rgba(146, 176, 201, 0.18)",
          layerA: "#85725e",
          layerB: "#4f4c46",
          layerC: "#24272d",
          river: "rgba(146, 181, 207, 0.16)",
          riverOpacity: "0.12",
          fallsOpacity: "0",
          starsOpacity: "0.28",
          orbRight: "17%",
    ...
    facts: [
      {
        label: "History",
        title: "Created in 1964, enlarged later",
        text: "President Lyndon B. Johnson signed the law establishing Canyonlands National Park on September 12, 1964, and Congress expanded the park to its present size in 1971.",
      },
      {
        label: "Geography",
        title: "Rivers divide the experience",
        text: "The Green and Colorado rivers split the park into Island in the Sky, The Needles, The Maze, and the river corridors themselves, with no internal road crossings to join them.",
      },
      {
        label: "Scale",
        title: "Immensity comes with separation",
        text: "Canyonlands is Utah's largest national park, but its defining character is not acreage alone. It is the way mesas, buttes, and deep gorges isolate each district into its own world.",
      },
    ],
    cta: {
      meta: "Trip planning",
      title: "Open the official Canyonlands National Park site.",
      text: "Use the official NPS site for district-specific directions, road conditions, hiking and backcountry guidance, weather, and current planning details before a visit.",
      label: "Visit Canyonlands on NPS",
    },
    theme: {
      bgTop: "#071018",
      bgBottom: "#160e0b",
      surface: "rgba(14, 17, 21, 0.72)",
      surfaceStrong: "rgba(17, 21, 25, 0.9)",
      card: "rgba(244, 232, 214, 0.08)",
      cardStrong: "rgba(244, 232, 214, 0.13)",
      line: "rgba(226, 200, 168, 0.16)",
      text: "#f7f0e7",
      muted: "#ccbda9",
      accent: "#d88a53",
      accentBright: "#f5ddb0",
      accentSecondary: "#97b5c9",
      shadow: "rgba(0, 0, 0, 0.36)",
      heroSkyTop: "#161f30",
      heroSkyBottom: "#8c6348",
      heroHorizon: "rgba(247, 219, 169, 0.44)",
      heroRidgeBack: "#926b52",
      heroRidgeMid: "#5b3f2e",
      heroRidgeFront: "#2d1d14",
      heroGlow: "rgba(244, 197, 134, 0.22)",
    },
  },
  carl: {
    code: "CAVE",
